...
namespace RestApi.Migrations
{
    ...
    [Migration("20220517090016_add NumberClass for membership to cal number of class when member log by device")]
    partial class addNumberClassformembershiptocalnumberofclasswhenmemberlogbydevice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.BillOfEntery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entities.EditorsUser", b =>
                {
                    ...
                    b.ToTable("EditorsUser", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.EntryAccounting", b =>
                {
                    ...
                    b.ToTable("EntryAccounting", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.EntryMovement", b =>
                {
                    ...
                    b.ToTable("EntryMovement", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.MembershipMovement", b =>
                {
                    ...
                    b.ToTable("MembershipMovement", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.MembershipMovementOrder", b =>
                {
                    ...
                    b.ToTable("MembershipMovementOrder", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.Oprationsy", b =>
                {
                    ...
                    b.ToTable("Oprationsys", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.OriginItem", b =>
                {
                    ...
                    b.ToTable("OriginItem", (string)null);
                });
            ...
            modelBuilder.Entity("Entities.StocktakingInventory", b =>
                {
                    ...
                    b.ToTable("StocktakingInventory", (string)null);
                });

            modelBuilder.Entity("Entities.TreeAccount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entities.Bank", b =>
                {
                    b.HasOne("Entities.TreeAccount", "Account")
                        .WithMany("Banks")
            ...
            modelBuilder.Entity("Entities.InventoryMovement", b =>
                {
                    b.HasOne("Entities.BillOfEntery", "BillOfEntery")
                        .WithMany()
